...
interface SimulationUploadViewProps {
  onDataLoaded: (results: OptimizationResult[]) => void;
  onBackToLanding: () => void;
}

export default function SimulationUploadView({
  onDataLoaded,
  onBackToLanding,
}: SimulationUploadViewProps) {
